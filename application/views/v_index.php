<section>
    <head><link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/stylebuku.css?v=<?php echo time(); ?>">
        ...
        <P>MVC adalah teknik atau konsep yang memisahkan komponen utama menjadi tiga komponen yaitu model, view dan controller.</p>
            ...
            <ol type="a">
            <li>Model</li>
<p align='justify'>Model adalah kelas yang merepresentasikan atau memodelkan tipe data yang akan digunakan oleh aplikasi. Model juga dapat didefinisakn sebagai bagian penangan yang berhubungan dengan pengolahan atau manipulasi database. Seperti misalnya mengambil data 
...
database (model) di ambil oleh controller dan kemudia controller
...
model yang mengambil data pada database, kemudia controller yang 
